...
exports.up = function(knex) {
  // this will be used to store aggregate metrics for episodes, WITHOUT storing any client identifiers or personal / device-specific information. Example: user starts an episode, then finishes the episode. Two records are created with the same occasion ID and event names 'episodeStarted' and 'episodeFinished'
  ...
  return knex.schema.createTable('client_events', table => {
...
exports.down = function(knex) {
  return knex.schema.dropTable('client_events')
};
