...
const insertDynamicLink = () => {
  ...
  document.getElementById('step1').innerHTML += `<p class="text-left">Open up a new tab with our admin panel at <a href="${adminURL}" target="_blank"> ${window.location.protocol}//${currentUrlHostname}/admin by clicking here</a></p>`
}
insertDynamicLink();